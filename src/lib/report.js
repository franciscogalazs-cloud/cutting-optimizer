...
export function generateReportHTML(result, pieces, materials, config) {
  ...
  .stat-card { border: 1px solid #bfefff; padding: 10px; border-radius: 6px; text-align: center; }
  ...
  .pattern-figure svg { width: 100%; max-width: 560px; height: auto; border: 1px solid #bfefff; border-radius: 6px; background: #ffffff; }
    </style>
  `;
